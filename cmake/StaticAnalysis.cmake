...
# We pass explicit compile flags after `--` rather than using compile_commands.json,
# so clang-tidy does NOT replay the `-fplugin=orthodoxy.so` flag (the Orthodoxy
# plugin is a clang-22 compiler plugin and crashes inside clang-tidy's tooling
# path; Orthodox enforcement already happens at build time via the compiler).
